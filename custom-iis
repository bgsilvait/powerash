...
Function iis{
    ...
    -AtElement @{name = "IP" ; value = $env:POD_IP}
    Add-WebConfigurationProperty -PSPath MACHINE/WEBROOT/APPHOST `
    -Name . -Filter system.webServer/httpProtocol/customHeaders `
    -AtElement @{name = "ServiceAccount" ; value = $env:POD_SERVICE_ACCOUNT} 
    Add-WebConfigurationProperty -PSPath MACHINE/WEBROOT/APPHOST `
    -Name . -Filter system.webServer/httpProtocol/customHeaders `
    -AtElement @{name = "Namespace" ; value = $env:POD_NAMESPACE}
    Add-WebConfigurationProperty -PSPath MACHINE/WEBROOT/APPHOST `
    -Name . -Filter system.webServer/httpProtocol/customHeaders `
    -AtElement @{name = "Node" ; value = $env:NODE_NAME}
    Add-WebConfigurationProperty -PSPath MACHINE/WEBROOT/APPHOST `
    -Name . -Filter system.webServer/httpProtocol/customHeaders `
    -AtElement @{name = "Pod" ; value = $env:POD_NAME}
